...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "925b1d5fb1a6bf6c77e1ab73659f0f23";
    ...
    final String LOGCAT_TAG = "WeatherController";
    ...
    Button saveBtn;
    ImageView historyImageView,shareImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historyImageView = findViewById(R.id.history_imageView);
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(weatherData!=null) {
                    saveWeather(weatherData.getCity(),weatherData.getTemperature());
                    Toast.makeText(WeatherController.this,"Data saved",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(WeatherController.this,"No data available to save.",Toast.LENGTH_SHORT).show();
                }
            }
        });
        historyImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(WeatherController.this,HistoryActivity.class));
            }
        });
        shareImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                share();
                    ...
                    Toast.makeText(WeatherController.this,"No data available to share.",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void letsDoSomeNetworking(RequestParams params) {
        ...
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                Log.d(TAG, "onSuccess: weatherData:"+weatherData);
    ...
    void saveWeather(String cityName,String temprature){
        SaveData.weatherHistoryList.add(new HistoryObj(cityName,temprature,getCurrentDate()));
        saveData.saveWeatherList(SaveData.weatherHistoryList);
    }
...
//        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "subject here");
        shareintent.putExtra(Intent.EXTRA_TEXT,
                "Location: "+weatherData.getCity()
                        +"\nTemprature: "+weatherData.getTemperature()+"\u00B0"
                        +"\nDate: "+getCurrentDate()

        );

        startActivity(Intent.createChooser(shareintent, "Pick To Share!"));
    }
}
